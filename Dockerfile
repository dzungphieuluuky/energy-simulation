...
RUN mkdir -p /root/.MathWorks/MatlabRuntimeCache/R2025a/main_r0/main_run_sce/simulation/scenarios/
RUN cp /app/scenarios/*.json /root/.MathWorks/MatlabRuntimeCache/R2025a/main_r0/main_run_sce/simulation/scenarios/
